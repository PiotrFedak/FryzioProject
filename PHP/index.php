...
do {
    ...
    echo("Scenariusz 3: Wypożyczenie książki").PHP_EOL;    
    echo("Scenariusz 4: Oddanie Książki").PHP_EOL;   
...
if ($scenariusz == 2) {
    ...
    unset($rezerwacja);
    echo("Usunięto rezerwację").PHP_EOL;
}
...
if ($scenariusz == 3) {
    do {
        echo("Wybierz rodzaj scenariusza: ").PHP_EOL;
        echo("Scenariusza główny - 1").PHP_EOL;
        echo("Scenariusza alternatywny minął termin rezerwacji - 2").PHP_EOL;
...
if ($scenariusz == 4) {
    do {
        echo("Wybierz rodzaj scenariusza: ").PHP_EOL;
        echo("Scenariusza główny - 1").PHP_EOL;
        echo("Scenariusza alternatywny książka oddana po terminie - 2").PHP_EOL;
        $wybór = readline("Podaj numer scenariusza: ");
